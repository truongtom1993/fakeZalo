				...
				<div className='comment_form mr-10 flex flex-col border rounded-md px-4 divide-y justify-between space-y-4 shadow-md'>
					...
					<div className='show_time pt-2'>
						<div className='flex space-x-3'>
							...
							<label htmlFor='time_left'>Left</label> <input type='radio' name='timeType' id='time_left' value='left' defaultChecked />
					...
					<div className='show_emoji flex flex-col pt-2 '>
						...
						<div className='space-x-2 divide-x flex'>
							<div className=''>
								<label htmlFor='Strong'>Strong</label> <input type='radio' name='emojiType' value={Emoji.Like} id='Strong' />
							</div>
							<div className='pl-3'>
								<label htmlFor='Heart'>Heart</label> <input type='radio' name='emojiType' value={Emoji.Heart} id='Heart' defaultChecked />
							</div>
							<div className='pl-3'>
								<label htmlFor='LoL'>LoL</label> <input type='radio' name='emojiType' value={Emoji.Lol} id='LoL' />
							</div>
							<div className='pl-3'>
								<label htmlFor='Wow'>Wow</label> <input type='radio' name='emojiType' value={Emoji.Wow} id='Wow' />
							</div>
							<div className='pl-3'>
								<label htmlFor='Cry'>Cry</label> <input type='radio' name='emojiType' value={Emoji.Cry} id='Cry' />
							</div>
							<div className='pl-3'>
								<label htmlFor='Angry'>Angry</label> <input type='radio' name='emojiType' value={Emoji.Angry} id='Angry' />
							</div>
						</div>
